...
var _user$project$Route$toSimpleString = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'Home':
			return '';
...
var _user$project$Route$toString = function (route) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#/',
		_user$project$Route$toSimpleString(route));
};
var _user$project$Route$toHref = function (route) {
	return _elm_lang$html$Html_Attributes$href(
		_user$project$Route$toString(route));
};
var _user$project$Route$toParser = function (route) {
	return A2(
...
var _user$project$Route$Repos = {ctor: 'Repos'};
...
var _user$project$Route$parser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: _user$project$Route$toParser(_user$project$Route$Home),
		_1: {
			ctor: '::',
			_0: _user$project$Route$toParser(_user$project$Route$Login),
			_1: {
				ctor: '::',
				_0: _user$project$Route$toParser(_user$project$Route$User),
				_1: {
					ctor: '::',
					_0: _user$project$Route$toParser(_user$project$Route$Repos),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_user$project$Route$Home) : A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Route$parser, location);
};

var _user$project$Page$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Page$Loading = {ctor: 'Loading'};
var _user$project$Page$Repos = {ctor: 'Repos'};
var _user$project$Page$User = {ctor: 'User'};
var _user$project$Page$Logout = {ctor: 'Logout'};
var _user$project$Page$Login = {ctor: 'Login'};
var _user$project$Page$fromLocation = function (location) {
	var maybeRoute = _user$project$Route$fromLocation(location);
	var _p0 = maybeRoute;
	if (_p0.ctor === 'Just') {
		switch (_p0._0.ctor) {
			case 'Home':
				return _user$project$Page$User;
			case 'Login':
				return _user$project$Page$Login;
			case 'Logout':
				return _user$project$Page$Logout;
			case 'User':
				return _user$project$Page$User;
			default:
				return _user$project$Page$Repos;
		}
	} else {
		return _user$project$Page$User;
	}
...
var _user$project$Request$toBasicAuth = function (_p0) {
	var _p1 = _p0;
	var hash = _truqu$elm_base64$Base64$encode(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_p1.username,
			A2(_elm_lang$core$Basics_ops['++'], ':', _p1.password)));
	return A2(
		_elm_lang$http$Http$header,
		'Authorization',
		A2(_elm_lang$core$Basics_ops['++'], 'Basic ', hash));
};
var _user$project$Request$request = F4(
	function (method, url, decoder, creds) {
		return _elm_lang$http$Http$request(
			{
				method: method,
				headers: {
					ctor: '::',
					_0: _user$project$Request$toBasicAuth(creds),
					_1: {ctor: '[]'}
				},
				url: url,
				body: _elm_lang$http$Http$emptyBody,
...
var _user$project$Request$get = _user$project$Request$request('GET');
var _user$project$Request$load = F4(
	function (url, decoder, resultToMsg, creds) {
		return A2(
			_elm_lang$http$Http$send,
			resultToMsg,
			A3(_user$project$Request$get, url, decoder, creds));
	});

var _user$project$Types_User$User = F3(
	function (a, b, c) {
		return {login: a, name: b, email: c};
	});
var _user$project$Types_User$decoder = A3(
	...
	A3(
		...
		A3(
			...
			'login',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types_User$User))));
var _user$project$Types_User$request = F2(
	function (mapToMsg, creds) {
		return A4(_user$project$Request$load, 'https://api.github.com/user', _user$project$Types_User$decoder, mapToMsg, creds);
	});
var _user$project$Types_User$Session = function (a) {
	return {user: a};
};

var _user$project$Types_Config$Config = F2(
	function (a, b) {
		return {username: a, password: b};
	});

var _user$project$Views_Page$frameHeader = A2(
	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('navbar-toggler d-lg-none'),
					_1: {
						ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$form,
								{
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'margin-bottom', _1: '0em'},
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('btn btn-outline-primary my-2 my-sm-0'),
											_1: {
												ctor: '::',
...
var _user$project$Views_Page$sideNavItem = F3(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Route$toHref(route),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$Views_Page$Repos = {ctor: 'Repos'};
var _user$project$Views_Page$Home = {ctor: 'Home'};
var _user$project$Views_Page$frameMain = F2(
	function (activePage, main) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('nav nav-pills flex-column'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A3(
											_user$project$Views_Page$sideNavItem,
											_elm_lang$core$Native_Utils.eq(activePage, _user$project$Views_Page$Home),
										...
										_1: {
											...
											_0: A3(
												_user$project$Views_Page$sideNavItem,
												_elm_lang$core$Native_Utils.eq(activePage, _user$project$Views_Page$Repos),
												_user$project$Route$Repos,
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-sm-9 ml-sm-auto col-md-10 pt-3'),
									_1: {
										ctor: '::',
...
var _user$project$Views_Page$frame = F2(
	function (activePage, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Views_Page$frameHeader,
				_1: {
					ctor: '::',
					_0: A2(_user$project$Views_Page$frameMain, activePage, content),
					_1: {ctor: '[]'}
				}
			});
	});

var _user$project$Pages_User$viewLoaded = function (userResult) {
	var txt = function () {
		var _p0 = userResult;
		if (_p0.ctor === 'Ok') {
...
var _user$project$Pages_User$viewLoading = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _user$project$Pages_User$view = function (model) {
	var _p1 = model.session.user;
	if (_p1.ctor === 'Loading') {
		return _user$project$Pages_User$viewLoading;
	} else {
		return _user$project$Pages_User$viewLoaded(_p1._0);
	}
};
var _user$project$Pages_User$update = F2(
	function (msg, model) {
		var _p2 = msg;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					session: _user$project$Types_User$Session(
						_user$project$Page$Loaded(_p2._0))
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Pages_User$Model = function (a) {
	return {session: a};
};
var _user$project$Pages_User$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Pages_User$load = function (creds) {
	return A2(_user$project$Types_User$request, _user$project$Pages_User$Loaded, creds);
};

var _user$project$Types_Repo$Repo = F3(
	function (a, b, c) {
		return {name: a, url: b, description: c};
	});
var _user$project$Types_Repo$decoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'description',
	...
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types_Repo$Repo))));

var _user$project$Pages_Repos$descToString = function (maybeDesc) {
	var _p0 = maybeDesc;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Pages_Repos$viewRepo = function (repo) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(repo.url),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_user$project$Pages_Repos$descToString(repo.description)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Pages_Repos$viewLoaded = function (result) {
	var body = function () {
		var _p1 = result;
		if (_p1.ctor === 'Ok') {
			return A2(_elm_lang$core$List$map, _user$project$Pages_Repos$viewRepo, _p1._0);
		} else {
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
...
var _user$project$Pages_Repos$viewLoading = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('spinner'),
...
var _user$project$Pages_Repos$view = function (model) {
	var _p2 = model.reposData;
	if (_p2.ctor === 'Loading') {
		return _user$project$Pages_Repos$viewLoading;
	} else {
		return _user$project$Pages_Repos$viewLoaded(_p2._0);
	}
};
var _user$project$Pages_Repos$update = F2(
	function (msg, model) {
		var _p3 = msg;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					reposData: _user$project$Page$Loaded(_p3._0)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Pages_Repos$Model = function (a) {
	return {reposData: a};
};
var _user$project$Pages_Repos$LoadedRepos = function (a) {
	return {ctor: 'LoadedRepos', _0: a};
};
var _user$project$Pages_Repos$load = function (creds) {
	var decoder = _elm_lang$core$Json_Decode$list(_user$project$Types_Repo$decoder);
	return A4(_user$project$Request$load, 'https://api.github.com/user/repos', decoder, _user$project$Pages_Repos$LoadedRepos, creds);
};
...
var _user$project$Pages_Login$Model = F2(
	function (a, b) {
		return {githubId: a, accessToken: b};
	});
var _user$project$Pages_Login$SignIn = {ctor: 'SignIn'};
var _user$project$Pages_Login$UpdateAccessToken = function (a) {
	return {ctor: 'UpdateAccessToken', _0: a};
};
var _user$project$Pages_Login$UpdateGitHubId = function (a) {
	return {ctor: 'UpdateGitHubId', _0: a};
};
var _user$project$Pages_Login$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container signin-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-signin'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$action('#/login'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Pages_Login$SignIn),
							_1: {ctor: '[]'}
						}
					}
				},
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$label,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('githubId'),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('GitHub ID'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Pages_Login$UpdateGitHubId),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('githubId'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder('GitHub ID'),
													_1: {
														ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$label,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$for('accessToken'),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Personal Access Token'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Pages_Login$UpdateAccessToken),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('form-control'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('accessToken'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('Personal Access Token'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'required', ''),
															_1: {
...
var _user$project$Main$mapUpdate = F4(
	function (mapModel, mapMsg, model, _p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					pageModel: mapModel(_p1._0)
				}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, mapMsg, _p1._1)
		};
	});
var _user$project$Main$Creds = F2(
	function (a, b) {
		return {username: a, password: b};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {credentials: a, session: b, pageModel: c};
	});
var _user$project$Main$ReposPageModel = function (a) {
	return {ctor: 'ReposPageModel', _0: a};
};
var _user$project$Main$UserPageModel = function (a) {
	return {ctor: 'UserPageModel', _0: a};
};
var _user$project$Main$LoginPageModel = function (a) {
	return {ctor: 'LoginPageModel', _0: a};
};
var _user$project$Main$init = function (location) {
	var emptyCreds = A2(_user$project$Main$Creds, '', '');
	return {
		ctor: '_Tuple2',
		_0: A3(
			_user$project$Main$Model,
			emptyCreds,
			_user$project$Types_User$Session(_user$project$Page$Loading),
			_user$project$Main$LoginPageModel(
				A2(_user$project$Pages_Login$Model, '', ''))),
		_1: _elm_lang$navigation$Navigation$newUrl(
			_user$project$Route$toString(_user$project$Route$Login))
	};
};
var _user$project$Main$ReposPageMsg = function (a) {
	return {ctor: 'ReposPageMsg', _0: a};
};
var _user$project$Main$UserPageMsg = function (a) {
...
var _user$project$Main$loadPage = F2(
	function (page, model) {
		...
		switch (_p2.ctor) {
			case 'Login':
				var pageModel = _user$project$Main$LoginPageModel(
					A2(_user$project$Pages_Login$Model, '', ''));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Logout':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'User':
				var pageCmd = _user$project$Pages_User$load(model.credentials);
				var pageModel = _user$project$Main$UserPageModel(
					_user$project$Pages_User$Model(
						_user$project$Types_User$Session(_user$project$Page$Loading)));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{pageModel: pageModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$UserPageMsg, pageCmd)
				};
			default:
				var pageCmd = _user$project$Pages_Repos$load(model.credentials);
				var pageModel = _user$project$Main$ReposPageModel(
					_user$project$Pages_Repos$Model(_user$project$Page$Loading));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{pageModel: pageModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ReposPageMsg, pageCmd)
				};
		}
	});
	...
	switch (_p3.ctor) {
		case 'LoginPageModel':
			return A2(
				...
				_user$project$Pages_Login$view(_p3._0));
		case 'UserPageModel':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$UserPageMsg,
				A2(
					_user$project$Views_Page$frame,
					_user$project$Views_Page$Home,
					_user$project$Pages_User$view(_p3._0)));
		default:
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$ReposPageMsg,
				A2(
					_user$project$Views_Page$frame,
					_user$project$Views_Page$Repos,
					_user$project$Pages_Repos$view(_p3._0)));
	}
};
var _user$project$Main$LoadPage = function (a) {
	return {ctor: 'LoadPage', _0: a};
};
var _user$project$Main$LoadedSession = function (a) {
	return {ctor: 'LoadedSession', _0: a};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p4 = {ctor: '_Tuple2', _0: msg, _1: model.pageModel};
		_v3_6:
		do {
			switch (_p4._0.ctor) {
				case 'LoadedSession':
					var changeUrlToHome = _elm_lang$navigation$Navigation$newUrl(
						_user$project$Route$toString(_user$project$Route$Home));
					var pageModel = _user$project$Main$UserPageModel(
						_user$project$Pages_User$Model(
							_user$project$Types_User$Session(_user$project$Page$Loading)));
					var session = _user$project$Types_User$Session(
						_user$project$Page$Loaded(_p4._0._0));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{session: session, pageModel: pageModel}),
						_1: changeUrlToHome
					};
				case 'LoginPageMsg':
					if (_p4._1.ctor === 'LoginPageModel') {
						if (_p4._0._0.ctor === 'SignIn') {
							var _p5 = _p4._1._0;
							var creds = A2(_user$project$Main$Creds, _p5.githubId, _p5.accessToken);
							var loadSession = A2(_user$project$Types_User$request, _user$project$Main$LoadedSession, creds);
							return A2(
								...
								'LoginPageMsg',
								{
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											session: _user$project$Types_User$Session(_user$project$Page$Loading),
											credentials: creds
										}),
									_1: loadSession
								});
							...
							return A4(
								_user$project$Main$mapUpdate,
								_user$project$Main$LoginPageModel,
								_user$project$Main$LoginPageMsg,
								model,
								A2(_user$project$Pages_Login$update, _p4._0._0, _p4._1._0));
						}
					} else {
						break _v3_6;
					}
				case 'LoadPage':
					return A4(_elm_lang$core$Debug$log, 'loadPage', _user$project$Main$loadPage, _p4._0._0, model);
				case 'UserPageMsg':
					if (_p4._1.ctor === 'UserPageModel') {
						return A4(
							_user$project$Main$mapUpdate,
							_user$project$Main$UserPageModel,
							_user$project$Main$UserPageMsg,
							model,
							A2(_user$project$Pages_User$update, _p4._0._0, _p4._1._0));
					} else {
						break _v3_6;
					}
				default:
					if (_p4._1.ctor === 'ReposPageModel') {
						return A4(
							_user$project$Main$mapUpdate,
							_user$project$Main$ReposPageModel,
							_user$project$Main$ReposPageMsg,
							model,
							A2(_user$project$Pages_Repos$update, _p4._0._0, _p4._1._0));
					} else {
						break _v3_6;
					}
			}
...
var _user$project$Main$main = A2(
	...
	function (_p6) {
		return _user$project$Main$LoadPage(
			_user$project$Page$fromLocation(_p6));
	},
	{
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Pages.Repos.Msg":{"args":[],"tags":{"LoadedRepos":["Result.Result Http.Error (List Types.Repo.Repo)"]}},"Pages.User.Msg":{"args":[],"tags":{"Loaded":["Result.Result Http.Error Types.User.User"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"UserPageMsg":["Pages.User.Msg"],"ReposPageMsg":["Pages.Repos.Msg"],"LoadPage":["Page.Page"],"LoadedSession":["Result.Result Http.Error Types.User.User"],"LoginPageMsg":["Pages.Login.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Pages.Login.Msg":{"args":[],"tags":{"SignIn":[],"UpdateAccessToken":["String"],"UpdateGitHubId":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.Page":{"args":[],"tags":{"Logout":[],"Repos":[],"User":[],"Login":[]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.Repo.Repo":{"args":[],"type":"{ name : String, url : String, description : Maybe.Maybe String }"},"Types.User.User":{"args":[],"type":"{ login : String, name : String, email : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
