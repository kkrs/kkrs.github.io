...
var _user$project$Route$Incidents = {ctor: 'Incidents'};
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Route$Incidents,
						_evancz$url_parser$UrlParser$s('incidents')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
...
var _user$project$Views_Menu$renderItem = F2(
	function (maybeActiveItem, _p0) {
		var _p1 = _p0;
		var isActive = function () {
			var _p2 = maybeActiveItem;
			if (_p2.ctor === 'Nothing') {
				return false;
			} else {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(_p1._2),
						_1: {
							ctor: '::',
...
var _user$project$Views_Menu$Users = {ctor: 'Users'};
var _user$project$Views_Menu$Incidents = {ctor: 'Incidents'};
var _user$project$Views_Menu$toRepresentation = function (item) {
	var _p3 = item;
	if (_p3.ctor === 'Incidents') {
		return {
			ctor: '_Tuple3',
			_0: _user$project$Views_Menu$Incidents,
			_1: 'Incidents',
			_2: _user$project$Route$toHref(_user$project$Route$Incidents)
		};
	} else {
		return {
			ctor: '_Tuple3',
			_0: _user$project$Views_Menu$Users,
			_1: 'Users',
			_2: _user$project$Route$toHref(_user$project$Route$Users)
		};
	}
};
var _user$project$Views_Menu$menu = A2(
	_elm_lang$core$List$map,
	_user$project$Views_Menu$toRepresentation,
	{
		ctor: '::',
		_0: _user$project$Views_Menu$Incidents,
		_1: {
...
var _user$project$Views_Menu$render = function (activeItem) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Views_Menu$renderItem(activeItem),
		_user$project$Views_Menu$menu);
};
var _user$project$Views_Menu$view = function (activeItem) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				_user$project$Views_Menu$render(activeItem)),
			_1: {ctor: '[]'}
		});
};

var _user$project$Views_Login$view = A2(
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('button esc-button'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('/'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('login-link'),
														_1: {ctor: '[]'}
													}
												}
											},
											{
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Login with Github'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _user$project$Page$viewFooter = A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('escalate'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' is licensed under '),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://www.apache.org/licenses/LICENSE-2.0'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Apache 2.0 '),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'padding: 0 5px'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('© 2017 Karthik Krishnamurthy'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Page$viewLogin = function (_p0) {
	return {
		ctor: '::',
		_0: _user$project$Views_Login$view,
		_1: {
			ctor: '::',
			_0: _user$project$Page$viewFooter,
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Page$viewHeader = function () {
	var logoutText = _user$project$Route$toString(_user$project$Route$Logout);
	var logoutLink = _user$project$Route$toHref(_user$project$Route$Logout);
	return A2(
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href(logoutLink),
															_1: {ctor: '[]'}
														}
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(logoutText),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
...
var _user$project$Page$toMenuItem = function (page) {
	var _p1 = page;
	switch (_p1.ctor) {
		case 'Home':
			return _elm_lang$core$Maybe$Just(_user$project$Views_Menu$Incidents);
		case 'Incidents':
			return _elm_lang$core$Maybe$Just(_user$project$Views_Menu$Incidents);
		case 'Users':
			return _elm_lang$core$Maybe$Just(_user$project$Views_Menu$Users);
		case 'Error':
			return _elm_lang$core$Maybe$Nothing;
		default:
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Page$viewMain = function (page) {
	return A2(
		_elm_lang$html$Html$main_,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('is-fluid columns'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Views_Menu$view(
								_user$project$Page$toMenuItem(page)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('column is-4'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('detail'),
									_1: {
										ctor: '::',
...
var _user$project$Page$viewHome = function (page) {
	return {
		ctor: '::',
		_0: _user$project$Page$viewHeader,
		_1: {
			ctor: '::',
			_0: _user$project$Page$viewMain(page),
			_1: {
				ctor: '::',
				_0: _user$project$Page$viewFooter,
				_1: {ctor: '[]'}
...
var _user$project$Page$frame = function (page) {
	var pageContent = function () {
		var _p2 = page;
		if (_p2.ctor === 'Login') {
			return _user$project$Page$viewLogin(page);
		} else {
			return _user$project$Page$viewHome(page);
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$Page$Error = {ctor: 'Error'};
var _user$project$Page$Users = {ctor: 'Users'};
var _user$project$Page$Incidents = {ctor: 'Incidents'};
...
var _user$project$Main$logout = function (model) {
	return {
		...
		_1: _elm_lang$navigation$Navigation$newUrl(
			_user$project$Route$toHref(_user$project$Route$Login))
	};
};
var _user$project$Main$navigateTo = F2(
		...
		if (_p0.ctor === 'Nothing') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{navigateTo: _user$project$Page$Error}),
			...
			switch (_p0._0.ctor) {
				case 'Home':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{navigateTo: _user$project$Page$Incidents}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Login':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{navigateTo: _user$project$Page$Login}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Logout':
					return _user$project$Main$logout(model);
				case 'Incidents':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
				...
				default:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{navigateTo: _user$project$Page$Users}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
		}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		return A2(_user$project$Main$navigateTo, _p1._0, model);
	});
var _user$project$Main$view = function (model) {
	return _user$project$Page$frame(model.navigateTo);
};
...
var _user$project$Main$init = function (location) {
	return A2(
		...
		_user$project$Main$Model(_user$project$Page$Home));
};
...
var _user$project$Main$main = A2(
	...
	function (_p2) {
		return _user$project$Main$NavigateTo(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Route.Route":{"args":[],"tags":{"Home":[],"Logout":[],"Users":[],"Incidents":[],"Login":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"NavigateTo":["Maybe.Maybe Route.Route"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
